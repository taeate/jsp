    ...
    <%@ include file="../common/head.jspf" %>
      <section>
        <div class="container mx-auto px-3 mt-5">
          <div class="flex">
            <div class="mt-4">
              <span class="text-blue-800 text-lg">${board.name}</span>
              <span class="ml-2">게시물 개수 :
                <div class="badge">${articlesCount}</div> 개
            </div>
            </span>
            ...
            <form class="flex">
              ...
              <input type="text" name="searchKeyword" class="input input-bordered ml-2 w-64" placeholder="검색어를 입력해주세요."
              ...
              <tbody>
                <c:forEach var="article" items="${articles}">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn-text-link w-full block truncate"
